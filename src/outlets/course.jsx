...
import EditFile from "../componenet/edit_File";
import Inbox from "../componenet/inbox";
import AddFile from "../componenet/addFile";
  ...
  return (
    <div className="class-page  p-4" dir="ltr">
      <div className="row justify-content-center ">
        ...
        <hr className="m-2" />
        {console.log(courses.length + "nidnvcidnv")}
        ...
        <Inbox setUpdate={setUpdate} update={update} inbox={inbox} />
        <AddFile class_id={class_id} setUpdate={setUpdate} update={update} />
        <EditFile />
      </div>
    </div>
  );
